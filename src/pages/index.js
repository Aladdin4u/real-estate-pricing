    ...
    >
      <div className="absolute bottom-20 p-10 bg-gradient-to-t from-blue-500 backdrop-blur-sm flex place-items-center">
        <div className="flex flex-col">
          ...
          <Link href="/houses" className="flex w-full justify-center group dark:border-neutral-800 dark:bg-zinc-800/30 dark:from-inherit lg:static lg:w-auto rounded-xl lg:border lg:bg-gray-200 lg:hover:bg-gray-300 lg:p-4 dark:bg-zinc-800/30">
            Get started &nbsp;
